...
Note: This version of Galaxy Swapper v2 is rebuilt from [GalaxySwapper'ssourcecode](https://github.com/GalaxySwapperOfficial/Galaxy-Swapper-v2), if you'd like to download the official Galaxy Swapper v2, you can do so [here](https://galaxyswapperv2.com/Downloads/InGame.php)
